...
(defun my-insert-inverted-question-mark ()
  (interactive)
  (insert "¿"))

(defun my-insert-n-tilde ()
  (interactive)
  (let ((key-sequence (read-key-sequence "Press the n or N accent: ")))
    (cond
...
(defun my-insert-accented-character ()
  ...
  (let ((key-sequence (read-key-sequence "Press the character to accent: ")))
    (cond
     ((string= key-sequence "e") (insert "é"))
     ((string= key-sequence "a") (insert "á"))
     ((string= key-sequence "i") (insert "í"))
     ((string= key-sequence "o") (insert "ó"))
     ((string= key-sequence "u") (insert "ú"))
     ((string= key-sequence "E") (insert "É"))
     ((string= key-sequence "A") (insert "Á"))
     ((string= key-sequence "I") (insert "Í"))
     ((string= key-sequence "O") (insert "Ó"))
